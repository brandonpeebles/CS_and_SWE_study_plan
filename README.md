...
## Outline:
- [X] **Harvard CS50x:** Introduction to Computer Science [link](https://cs50.harvard.edu/x/2020/)
- [X] **freeCodeCamp** ([my Full Stack development certification](https://www.freecodecamp.org/certification/brandonpeebles/full-stack)) 
	...
	- [X] Information Security and Quality Assurance (HelmetJS, QA and Testing with Chai, Advanced Node & Express) 
- [X]  **Overview of Operating Systems:**
	- [X] [Operating Systems Concepts 10th Edition](https://www.amazon.com/Operating-System-Concepts-Abraham-Silberschatz-ebook/dp/B07CVKH7BD) _(in progress)_
...
### First section is again adapted directly from the Coding Interview University repo created by John Washam ([link](https://github.com/jwasham/coding-interview-university)). I've included it below so I can check things off as I go.
...
- [X] Introductory Discrete Mathematics (book)- quick review of set theory/logic + sections on analysis of algorithms
